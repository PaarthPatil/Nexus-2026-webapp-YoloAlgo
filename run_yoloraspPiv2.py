...
# === PI OPTIMIZATIONS ===
# The Raspberry Pi CPU is weak. We will skip frames to instantly gain 5x the mathematical operational speed!
FRAME_SKIP = 3 
# We explicitly force the mathematical resolution block down to 320px 
INFERENCE_SIZE = 320 
...
model.agnostic = False # VERY IMPORTANT: MUST BE FALSE OR NO BOXES WILL BE SEEN!
...
try:
    while cap.isOpened():
        ...
        print(f"[Raspberry Pi Feed] LIVE BOX COUNT: {official_smoothed_count} | Recorded Absolute Peak: {highest_stable_count} | Speed: {virtual_fps:.1f} FPS")

except KeyboardInterrupt:
    print("\n[!] User force-stopped the video feed manually using Ctrl+C.")
