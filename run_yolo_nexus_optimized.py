...
OUTPUT_MP4 = f"{OUTPUT_DIR}/nexus_optimized_result.mp4"
...
model.agnostic = False # Crucial for overlapping boxes
model.max_det = 100 
...
print(f"Processing started: {VIDEO_SOURCE}")
frame_count = 0
total_start_time = time.time()

# ==========================================
# 4. SYNCHRONOUS EXECUTION LOOP (Maximum Accuracy)
# ==========================================
try:
    while cap.isOpened():
        ...
        draw_text_with_background(frame, f"Accurate Count In ROI: {small_boxes_inside_roi}", (10, 70), font_scale=0.8, thickness=2, text_color=(0,255,0), bg_color=(0,0,0))
    ...
    print(f"Average FPS: {frame_count/total_duration:.1f}")
